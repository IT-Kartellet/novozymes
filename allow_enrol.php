...
$PAGE->navbar->add("Sign others up", new moodle_url('/blocks/metacourse/enrol_others_into_course.php'));
...
echo html_writer::tag('h1', "Who can sign you up?", array());
echo html_writer::start_tag('div',array('id' => 'meta_wrapper'));

echo html_writer::tag('h3', "Users who are allowed to sign you up for courses:");

...
function xmldb_block_metacourse_install() {
    ...
    $records[] = array("language"=>'Farsi','iso'=>'fa');
    ...
    $records[] = array("language"=>'Malay','iso'=>'ms');
    ...
    $records[] = array("language"=>'Serbian','iso'=>'sr');
